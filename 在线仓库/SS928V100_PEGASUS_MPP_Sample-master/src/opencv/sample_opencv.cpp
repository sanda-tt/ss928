...
static td_void sample_opencv_init_mem_share(td_void)
{
    td_u32 i;
...
#ifdef SAMPLE_MEM_SHARE_ENABLE
static td_void sample_opencv_init_vo_mem_share(ot_vo_layer vo_layer)
{
    td_s32 ret;
...
#ifdef SAMPLE_MEM_SHARE_ENABLE
    sample_opencv_init_vo_mem_share(vo_config->vo_dev);
#endif
