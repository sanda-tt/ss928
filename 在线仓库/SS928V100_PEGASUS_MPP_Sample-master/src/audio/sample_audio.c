...
extern td_void SDK_init(void);
extern td_void SDK_exit(void);
#endif
...
/* function : set ai track mode*/
static td_s32 sample_audio_set_track_mode(ot_audio_dev ai_dev, ot_audio_track_mode track_mode)
{
    td_s32 ret;
...
td_s32 sample_audio_ai_aenc(td_void)
{
    ...
    ot_audio_track_mode track_mode = OT_AUDIO_TRACK_BOTH_LEFT; //两个声道全部为左声道声音
    ...
    /* step 5: set ai track mode */
    sample_audio_set_track_mode(ai_dev, track_mode);
