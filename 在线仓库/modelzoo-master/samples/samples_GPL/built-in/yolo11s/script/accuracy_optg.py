    ...
    try:
        ...
        if "|" in detection_line:
            ...
            if len(parts) >= 3:
                ...
                class_id = yolo80_to_coco90[class_id]
...
def improved_process_all_results(txt_folder_path, gt_annotations_path):
    ...
    result_files = glob.glob(os.path.join(txt_folder_path, "*_result.txt"))
        ...
        try:
            ...
            for detection_line in yolo_outputs:
                ...
                if (
                    ...
                    x1_orig, y1_orig, x2_orig, y2_orig = box_coords
                    width, height = x2_orig - x1_orig, y2_orig - y1_orig
                    coco_detection = {
                        "image_id": image_id,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="YOLOv8s accuracy.")
    parser.add_argument(
        "--ground_truth_json",
        type=str,
