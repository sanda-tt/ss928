...
def image_to_bin(image_path, output_bin_path, target_size=(608, 608)):
    """将图片转换为bin文件"""
    # 读取图片，默认读取为BGR格式
...
def process_images(file_list_path, output_dir, bin_list_file, target_size=(608, 608), max_count=5000):
...
def main():
    ...
    parser.add_argument('--output_dir', default='../data/preprocess/bin',
                        help='输出bin文件路径')
    parser.add_argument('--target_size', type=int, nargs=2, default=[608, 608],
                        help='目标尺寸，格式为 宽 高，默认608 608')
