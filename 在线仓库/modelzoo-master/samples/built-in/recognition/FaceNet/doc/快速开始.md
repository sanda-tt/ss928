...
```
备注：上述C++代码依赖的动态库与头文件位于[/samples/common](https://gitee.com/HiSpark/modelzoo/tree/master/samples/common)目录下，编译相关配置参考[CMakeLists.txt](https://gitee.com/HiSpark/modelzoo/blob/master/samples/built-in/recognition/FaceNet/src/CMakeLists.txt)。