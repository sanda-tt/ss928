SiameseNetwork模型可以通过以下代码完成快速推理
```
#include "model.h"
#include "log.h"
...
```
备注：头文件和动态库位于[/samples/common](https://gitee.com/HiSpark/modelzoo/tree/master/samples/common)目录下，编译配置参考[文件](https://gitee.com/HiSpark/modelzoo/blob/master/samples/built-in/recognition/SiameseNetwork/src/CMakeLists.txt)