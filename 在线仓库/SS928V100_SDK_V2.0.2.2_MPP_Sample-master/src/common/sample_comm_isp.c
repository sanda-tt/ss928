...
static ot_isp_pub_attr g_isp_pub_attr_imx347_2l_slave_mipi_2m_30fps = {
...
static ot_isp_pub_attr g_isp_pub_attr_imx219_mipi_8m_15fps = {
    {0, 0, 3280, 2464},
    {3280, 2464},
    15,
    OT_ISP_BAYER_RGGB,
...
static ot_isp_pub_attr g_isp_pub_attr_gs1860_mipi_1m_30fps =
{
    {0, 0, 2560, 31},
    {2560, 31},
    30,
...
td_s32 sample_comm_isp_get_pub_attr_by_sns(sample_sns_type sns_type, ot_isp_pub_attr *pub_attr)
{
    switch (sns_type) {
        ...
        case SONY_IMX347_2L_SLAVE_MIPI_2M_30FPS_12BIT:
            (td_void)memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_imx347_2l_slave_mipi_2m_30fps, sizeof(ot_isp_pub_attr));
            break;
        ...
        case SONY_IMX219_2L_MIPI_8M_15FPS_10BIT:
            (td_void)memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_imx219_mipi_8m_15fps, sizeof(ot_isp_pub_attr));
            break;

        case HISI_GS1860_MIPI_1M_30FPS_10BIT:
            (td_void)memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_gs1860_mipi_1m_30fps, sizeof(ot_isp_pub_attr));
            break;
...
ot_isp_sns_obj *sample_comm_isp_get_sns_obj(sample_sns_type sns_type)
{
    switch (sns_type) {
        ...
        case SONY_IMX347_2L_SLAVE_MIPI_2M_30FPS_12BIT:
            return &g_sns_imx347_2l_slave_obj;
        case SONY_IMX485_MIPI_8M_30FPS_12BIT:
        case SONY_IMX485_MIPI_8M_30FPS_10BIT_WDR3TO1:
        ...
        case SONY_IMX219_2L_MIPI_8M_15FPS_10BIT:
            return &g_sns_imx219_2l_obj;
         case HISI_GS1860_MIPI_1M_30FPS_10BIT:
            return &g_sns_gs1860_obj;
        default:
            return TD_NULL;
    }
}
