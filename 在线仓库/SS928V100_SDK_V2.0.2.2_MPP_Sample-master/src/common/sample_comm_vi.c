...
#define WIDTH_3280 3280
#define HEIGHT_2464 2464
...
static combo_dev_attr_t g_mipi_2lane_chn0_sensor_imx347_slave_12bit_2m_nowdr_attr = {
    .devno = 0, /* dev0 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
...
static combo_dev_attr_t g_mipi_2lane_chn1_sensor_imx347_slave_12bit_2m_nowdr_attr = {
    .devno = 1, /* dev1 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 2, WIDTH_1920, HEIGHT_1080},
...
static combo_dev_attr_t g_mipi_2lane_chn2_sensor_imx347_slave_12bit_2m_nowdr_attr = {
    .devno = 2, /* dev2 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 2, WIDTH_1920, HEIGHT_1080},
...
static combo_dev_attr_t g_mipi_2lane_chn3_sensor_imx347_slave_12bit_2m_nowdr_attr = {
    .devno = 3, /* dev3 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 2, WIDTH_1920, HEIGHT_1080},
...
static combo_dev_attr_t g_mipi_2lane_chn0_sensor_sc450ai_4m_nowdr_attr = {
    .devno = 0, /* dev0 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_2688, HEIGHT_1520},
...
static combo_dev_attr_t g_mipi_2lane_chn1_sensor_sc450ai_4m_nowdr_attr = {
    .devno = 1, /* dev1 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_2688, HEIGHT_1520},
...
static combo_dev_attr_t g_mipi_2lane_chn2_sensor_sc450ai_4m_nowdr_attr = {
    .devno = 2, /* dev2 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_2688, HEIGHT_1520},
...
static combo_dev_attr_t g_mipi_2lane_chn3_sensor_sc450ai_4m_nowdr_attr = {
    .devno = 3, /* dev3 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_2688, HEIGHT_1520},
...
static combo_dev_attr_t g_mipi_2lane_chn0_sensor_sc450ai_2m_nowdr_attr = {
    .devno = 0, /* dev0 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
...
static combo_dev_attr_t g_mipi_2lane_chn1_sensor_sc450ai_2m_nowdr_attr = {
    .devno = 1, /* dev1 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_1920, HEIGHT_1080},
...
static combo_dev_attr_t g_mipi_2lane_chn2_sensor_sc450ai_2m_nowdr_attr = {
    .devno = 2, /* dev2 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_1920, HEIGHT_1080},
...
static combo_dev_attr_t g_mipi_2lane_chn3_sensor_sc450ai_2m_nowdr_attr = {
    .devno = 3, /* dev3 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_1920, HEIGHT_1080},
...
static combo_dev_attr_t g_mipi_2lane_chn0_sensor_imx219_10bit_8m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
    .img_rect = {0, 0, WIDTH_3280, HEIGHT_2464},
    .mipi_attr = {
        DATA_TYPE_RAW_10BIT,
        OT_MIPI_WDR_MODE_NONE,
        {0, 1, -1, -1, -1, -1, -1, -1}
...
static combo_dev_attr_t g_mipi_2lane_chn2_sensor_imx219_10bit_8m_nowdr_attr = {
    .devno = 2, /* dev 2 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
    .img_rect = {0, 0, WIDTH_3280, HEIGHT_2464},
...
static combo_dev_attr_t g_mipi_1lane_chn0_sensor_gs1860_10bit_1m_nowdr_attr = {
    .devno = 2,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_2560, HEIGHT_31},
    .mipi_attr  = {
        DATA_TYPE_RAW_10BIT,
        OT_MIPI_WDR_MODE_NONE,
        {4, -1, -1, -1, -1, -1, -1, -1}
...
static combo_dev_attr_t g_mipi_1lane_chn1_sensor_gs1860_10bit_1m_nowdr_attr = {
    .devno = 3,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_2560, HEIGHT_31},
...
static td_void sample_comm_vi_get_mipi_attr(sample_sns_type sns_type, combo_dev_attr_t *combo_attr)
{
    ...
    switch (sns_type) {
        ...
        case SONY_IMX347_2L_SLAVE_MIPI_2M_30FPS_12BIT:
            ob_height = IMX347_OB_HEIGHT_END;
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_2lane_chn0_sensor_imx347_slave_12bit_2m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;
        ...
        case SC450AI_2L_MIPI_4M_30FPS_10BIT:
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_2lane_chn0_sensor_sc450ai_4m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;

        case SC450AI_2L_MIPI_2M_30FPS_10BIT:
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_2lane_chn0_sensor_sc450ai_2m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;
        ...
        case SONY_IMX219_2L_MIPI_8M_15FPS_10BIT:
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_2lane_chn0_sensor_imx219_10bit_8m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;

        case HISI_GS1860_MIPI_1M_30FPS_10BIT:
            ob_height = OB_HEIGHT_START;
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_1lane_chn0_sensor_gs1860_10bit_1m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;
    ...
    switch (sns_type) {
        ...
        case SONY_IMX347_2L_SLAVE_MIPI_2M_30FPS_12BIT:
            ...
            if (vi_dev == 0) { /* dev0 */
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_2lane_chn1_sensor_imx347_slave_12bit_2m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            else if (vi_dev == 2) { /* dev2 */
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_2lane_chn2_sensor_imx347_slave_12bit_2m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            else if (vi_dev == 3) { /* dev3 */
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_2lane_chn3_sensor_imx347_slave_12bit_2m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            break;
        ...
        case SC450AI_2L_MIPI_4M_30FPS_10BIT:
            if (vi_dev == 0) { /* dev0 */
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_2lane_chn1_sensor_sc450ai_4m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            else if (vi_dev == 2) { /* dev2 */
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_2lane_chn2_sensor_sc450ai_4m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            else if (vi_dev == 3) { /* dev3 */
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_2lane_chn3_sensor_sc450ai_4m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            break;
        ...
        case SC450AI_2L_MIPI_2M_30FPS_10BIT:
            if (vi_dev == 0) { /* dev0 */
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_2lane_chn1_sensor_sc450ai_2m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            else if (vi_dev == 2) { /* dev2 */
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_2lane_chn2_sensor_sc450ai_2m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            else if (vi_dev == 3) { /* dev3 */
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_2lane_chn3_sensor_sc450ai_2m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            break;
        ...
        case SONY_IMX219_2L_MIPI_8M_15FPS_10BIT:
            if (vi_dev == 0) {
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_2lane_chn2_sensor_imx219_10bit_8m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            break;
        ...
        case HISI_GS1860_MIPI_1M_30FPS_10BIT:
            ...
            if (vi_dev == 2) { /* dev2 */
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_1lane_chn1_sensor_gs1860_10bit_1m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            break;
        default:
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
...
td_void sample_comm_vi_get_size_by_sns_type(sample_sns_type sns_type, ot_size *size)
{
    switch (sns_type) {
        ...
        case SONY_IMX485_MIPI_8M_30FPS_10BIT_WDR3TO1:
            ...
            break;
        case SONY_IMX219_2L_MIPI_8M_15FPS_10BIT:
            size->width  = WIDTH_3280;
            size->height = HEIGHT_2464;
            break;
        case OV_OS04A10_MIPI_4M_30FPS_12BIT:
        case SC450AI_MIPI_4M_30FPS_10BIT:
        case SC450AI_MIPI_4M_30FPS_10BIT_WDR2TO1:
                                             ...
                                             sample_vi_pipe_info pipe_info[])
{
    ...
    for (i = 0; i < bind_pipe->pipe_num; i++) {
        ...
        pipe_info[i].chn_need_start = TD_TRUE;
...
static td_s32 sample_comm_vi_start_one_pipe(ot_vi_pipe vi_pipe, const sample_vi_pipe_info *pipe_info)
{
    ...
    if (pipe_info->chn_need_start == TD_TRUE) {
