...
#endif
#ifdef CONFIG_OT_GDC_DSP_LUT_SUPPORT
    OT_SVP_DSP_CMD_GDC_LUT_PROC = 0x5,
#endif
#ifdef CONFIG_OT_HNR_DSP_PROC_SUPPORT
    OT_SVP_DSP_CMD_HNR_DSP_PROC = 0x6,
#endif
#ifdef CONFIG_OT_GDC_DSP_LUT_LIMIT_SUPPORT
    OT_SVP_DSP_CMD_GDC_LUT_LIMIT = 0x7,
#endif
#ifdef CONFIG_OT_DSP_SUB_INTEG_SUPPORT
    OT_SVP_DSP_CMD_SUB_INTEG = 0x8,
#endif
    OT_SVP_DSP_CMD_BUTT
} ot_svp_dsp_cmd;
