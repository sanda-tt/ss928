...
td_s32 ss_mpi_vi_set_chn_lut_attr(ot_vi_pipe vi_pipe, ot_vi_chn vi_chn, const ot_lut_attr *lut_attr);
td_s32 ss_mpi_vi_get_chn_lut_attr(ot_vi_pipe vi_pipe, ot_vi_chn vi_chn, ot_lut_attr *lut_attr);
