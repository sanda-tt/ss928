...
typedef struct {
    td_u32 odr; /* Range:[0x0, 0xFFFFFFFF]; output data rate of gyro, prec: 1024 */
    td_u32 fsr; /* Range:[0x0, 0xFFFFFFFF]; full scale range of gyro, prec: 1024 */
    td_u8  data_width; /* Range:[0x0, 0xFF]; data bit width of gyro, fixed value: 16 */
    /* Range:[-0x80000000, 0x7FFFFFFF]; maximum operating temperature of gyro, fixed value: 85 */
    td_s32 temperature_max;
    /* Range:[-0x80000000, 0x7FFFFFFF]; minimum operating temperature of gyro, fixed value: -40 */
    td_s32 temperature_min;
} ot_msensor_gyro_config;

typedef struct {
    td_u32 odr; /* Range:[0x0, 0xFFFFFFFF]; output data rate of acc, prec: 1024 */
    td_u32 fsr; /* Range:[0x0, 0xFFFFFFFF]; full scale range of acc, prec: 1024 */
    td_u8  data_width; /* Range:[0x0, 0xFF]; data bit width of acc, fixed value: 16 */
    /* Range:[-0x80000000, 0x7FFFFFFF]; maximum operating temperature of acc, fixed value: 85 */
    td_s32 temperature_max;
    /* Range:[-0x80000000, 0x7FFFFFFF]; minimum operating temperature of acc, fixed value: -40 */
    td_s32 temperature_min;
...
typedef struct {
    td_u32                dev_id;
    ot_msensor_data_info  data_info;
} ot_msensor_mult_data_info;

typedef struct {
    td_u32           dev_id;
    ot_msensor_data  data;
} ot_msensor_mult_data;

typedef struct {
    td_u32 dev_id;
    ot_msensor_param param;
} ot_msensor_mult_param;
