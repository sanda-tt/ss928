...
td_s32 ss_mpi_isp_set_ae_mot_detect_attr(ot_vi_pipe vi_pipe, const ot_isp_ae_mot_attr *ae_mot_attr);
td_s32 ss_mpi_isp_get_ae_mot_detect_attr(ot_vi_pipe vi_pipe, ot_isp_ae_mot_attr *ae_mot_attr);
#ifdef __cplusplus
}
#endif
