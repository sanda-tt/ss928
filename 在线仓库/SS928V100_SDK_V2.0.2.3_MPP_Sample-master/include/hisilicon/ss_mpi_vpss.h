...
td_s32 ss_mpi_vpss_set_chn_lut_attr(ot_vpss_grp grp, ot_vpss_chn chn, const ot_lut_attr *lut_attr);
td_s32 ss_mpi_vpss_get_chn_lut_attr(ot_vpss_grp grp, ot_vpss_chn chn, ot_lut_attr *lut_attr);
