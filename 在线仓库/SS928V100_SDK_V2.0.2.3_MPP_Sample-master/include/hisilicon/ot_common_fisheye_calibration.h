...
typedef struct {
    td_s32 offset_v; /* the horizontal offset between image center and physical center of lens */
    td_s32 offset_h; /* the vertical offset between image center and physical center of lens */
    td_s32 radius_x; /* the X coordinate of physical center of lens */
    td_s32 radius_y; /* the Y coordinate of physical center of lens */
    td_u32 radius;   /* the radius of lens */
