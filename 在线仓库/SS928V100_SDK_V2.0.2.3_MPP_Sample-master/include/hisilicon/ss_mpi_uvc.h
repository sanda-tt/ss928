...
td_s32 ss_mpi_uvc_create_chn_ex(ot_uvc_chn uvc_chn, const ot_uvc_chn_attr_ex *chn_attr_ex);
...
td_s32 ss_mpi_uvc_get_chn_attr_ex(ot_uvc_chn uvc_chn, ot_uvc_chn_attr_ex *chn_attr_ex);
