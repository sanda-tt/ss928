...
typedef enum {
    ...
    IOC_NR_MSENSOR_MNG_MULT_GET_DATA,
    IOC_NR_MSENSOR_MNG_MULT_RELEASE_BUF,
    IOC_NR_MSENSOR_MNG_MULT_ADD_USER,
    IOC_NR_MSENSOR_MNG_MULT_DELETE_USER,
    IOC_NR_MSENSOR_MNG_MULT_SEND_DATA,
...
#define MSENSOR_CMD_MULT_GET_DATA    _IOWR(MSENSOR_TYPE_MNG, IOC_NR_MSENSOR_MNG_MULT_GET_DATA,   \
    ot_msensor_mult_data_info)
#define MSENSOR_CMD_MULT_RELEASE_BUF _IOWR(MSENSOR_TYPE_MNG, IOC_NR_MSENSOR_MNG_MULT_RELEASE_BUF, \
    ot_msensor_mult_data_info)
#define MSENSOR_CMD_MULT_ADD_USER    _IOWR(MSENSOR_TYPE_MNG, IOC_NR_MSENSOR_MNG_MULT_ADD_USER,    ot_msensor_id)
#define MSENSOR_CMD_MULT_DELETE_USER _IOWR(MSENSOR_TYPE_MNG, IOC_NR_MSENSOR_MNG_MULT_DELETE_USER, ot_msensor_id)
#define MSENSOR_CMD_MULT_SEND_DATA   _IOW(MSENSOR_TYPE_MNG,  IOC_NR_MSENSOR_MNG_MULT_SEND_DATA,   ot_msensor_mult_data)
