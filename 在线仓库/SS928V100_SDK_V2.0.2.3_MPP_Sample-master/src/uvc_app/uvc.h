...
#define MAX_PAYLOAD_IMAGE_SIZE 4182016  /* 4MB =4 x 1024 x 1024 */
...
struct ot_uvc_streaming_control {
    ...
    td_u8 b_usage;
    td_u8 b_bit_depth_luma;
    td_u8 b_msettings;
    td_u8 b_max_number_of_ref_frames_plus1;
    td_u16 b_rate_control_modes;
    td_u64 b_m_layout_per_stream;
...
struct ot_uvc_dev {
    td_u32 dev_no; /* uvc device number, corresponding to uvc channel, X in /dev/videoX */
    td_s32 i_fd;
...
static const struct ot_uvc_format_info ot_fmt[] = {
    ...
    { VIDEO_IMG_FORMAT_NV12,  ot_uvc_frames_nv12  },
