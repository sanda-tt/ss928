...
#define OT_SCENE_PIPETYPE_NUM 7
...
typedef struct {
    ...
    td_bool blend_en;
    td_u32 iso_count;
    td_u32 iso_level_ltoh[OT_SCENE_ISO_STRENGTH_NUM];
    td_u32 manual_sfs[OT_SCENE_ISO_STRENGTH_NUM];
    td_u32 manual_tfs[OT_SCENE_ISO_STRENGTH_NUM];
...
typedef struct {
    ...
    ot_scene_dynamic_linear_ca dynamic_linear_ca;
