...
static td_s32 sample_hnr_start_venc_and_vo(ot_vpss_grp vpss_grp[], td_u32 grp_num, ot_size *in_size)
{
    ...
    } else if (SENSOR0_TYPE == SONY_IMX347_SLAVE_MIPI_4M_30FPS_12BIT) {
...
static td_s32 sample_hnr_set_blc(ot_vi_pipe vi_pipe, sample_sns_type sns_type)
{
    ...
    if ((sns_type == HY_S0603_MIPI_8M_30FPS_12BIT) || (sns_type == SONY_IMX347_SLAVE_MIPI_4M_30FPS_12BIT) || (sns_type == SONY_IMX485_MIPI_8M_30FPS_12BIT)) {
