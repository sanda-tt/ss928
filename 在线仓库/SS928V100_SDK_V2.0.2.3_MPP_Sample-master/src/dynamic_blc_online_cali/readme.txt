...
Step 1: Modify the sensor driver (hy_0603_cmos_ex.h). Change OT_ISP_BLACK_LEVEL_MODE_DYNAMIC to dynamic BLC mode.
...
The current calibration tool is only adapted to HY_S0603. To calibrate other sensors, set the statistical process for the gain value corresponding to the sensor in the set_gain_acor_sensor function.
