# Compile the nand_product tool.
	...
	a. Go to the osdrv/componment directory and decompress the secure function library.
		cd ordrv/componment
		tar -xzf ../../../mpp/component/secure_c.tgz -C .
		cd secure_c/src
	...
	c. Compile the nand_product tool.
		cd nand_production/fmc_nand_ecc_product_v100
		make
