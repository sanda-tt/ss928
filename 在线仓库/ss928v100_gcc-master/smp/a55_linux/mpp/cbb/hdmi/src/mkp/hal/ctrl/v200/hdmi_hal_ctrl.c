...
static td_s32 ctrl_vendor_infoframe_data_get(td_u32 id, td_u8 *data)
{
    ...
    hdmi_reg_vsif_pkt_header_get(id, &vsif_pkt_head);
    hdmi_reg_vsif_pkt0_low_get(id, &vsif_sub_pkt0_l);
    hdmi_reg_vsif_pkt0_high_get(id, &vsif_sub_pkt0_h);
    hdmi_reg_vsif_pkt1_low_get(id, &vsif_sub_pkt1_l);
    hdmi_reg_vsif_pkt1_high_get(id, &vsif_sub_pkt1_h);
    hdmi_reg_vsif_pkt2_low_get(id, &vsif_sub_pkt2_l);
    hdmi_reg_vsif_pkt2_high_get(id, &vsif_sub_pkt2_h);
    hdmi_reg_vsif_pkt3_low_get(id, &vsif_sub_pkt3_l);
    hdmi_reg_vsif_pkt3_high_get(id, &vsif_sub_pkt3_h);
...
static td_s32 ctrl_audio_infoframe_data_get(td_u32 id, td_u8 *data)
{
    ...
    hdmi_reg_aif_pkt_header_get(id, &aif_pkt_head);
    hdmi_reg_aif_pkt0_low_get(id, &aif_sub_pkt0_l);
    hdmi_reg_aif_pkt0_high_get(id, &aif_sub_pkt0_h);
    hdmi_reg_aif_pkt1_low_get(id, &aif_sub_pkt1_l);
    hdmi_reg_aif_pkt1_high_get(id, &aif_sub_pkt1_h);
    hdmi_reg_aif_pkt2_low_get(id, &aif_sub_pkt2_l);
    hdmi_reg_aif_pkt2_high_get(id, &aif_sub_pkt2_h);
    hdmi_reg_aif_pkt3_low_get(id, &aif_sub_pkt3_l);
    hdmi_reg_aif_pkt3_high_get(id, &aif_sub_pkt3_h);
...
static td_s32 ctrl_gbd_infoframe_data_get(td_u32 id, td_u8 *data)
{
    ...
    hdmi_reg_gamut_pkt_header_get(id, &gamut_pkt_head);
    hdmi_reg_gamut_pkt0_low_get(id, &gamut_sub_pkt0_l);
    hdmi_reg_gamut_pkt0_high_get(id, &gamut_sub_pkt0_h);
    hdmi_reg_gamut_pkt1_low_get(id, &gamut_sub_pkt1_l);
    hdmi_reg_gamut_pkt1_high_get(id, &gamut_sub_pkt1_h);
    hdmi_reg_gamut_pkt2_low_get(id, &gamut_sub_pkt2_l);
    hdmi_reg_gamut_pkt2_high_get(id, &gamut_sub_pkt2_h);
    hdmi_reg_gamut_pkt3_low_get(id, &gamut_sub_pkt3_l);
    hdmi_reg_gamut_pkt3_high_get(id, &gamut_sub_pkt3_h);
