...
- `skills/ss928-mt5710-5g-validation/SKILL.md`：测试或排查 TD Tech `MT5710/MT571X` 5G RedCap 模组时使用。包括 USB 枚举、`/dev/ttyUSB1` PCUI AT 指令、SIM/APN、蜂窝拨号、互联网连通、语音呼叫、SmartBag 严重摔倒 UCS2/PDU 短信告警、GNSS/定位状态和 MT5710 专属问题。
