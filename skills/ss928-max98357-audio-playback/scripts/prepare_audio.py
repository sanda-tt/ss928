...
def main() -> int:
    ...
    parser.add_argument(
        "--out-dir",
        type=Path,
        default=Path("work") / "max98357_i2s_test",
        help="Output folder. Default: work/max98357_i2s_test",
    )
    parser.add_argument("--remote-dir", default="/root/max98357_i2s_test")
