...
const TARGET_NAMES = ["DX-GP21-Track", "SmartBackpack-Track", "BMI270-Backpack"];
...
Page({
  data: {
    targetName: "DX-GP21-Track / SmartBackpack-Track",
    adapterReady: false,
    scanning: false,
    connecting: false,
    connected: false,
  ...
  connectFromTap(e) {
    ...
    const deviceName = e.currentTarget.dataset.deviceName || "DX-GP21-Track";
  ...
  requestTrackList() {
    this.writeCommand("TL");
  },

  requestStatus() {
    this.writeCommand("TS");
  },
  ...
  requestTrackChunk(trackIndex, offset) {
    this.writeCommand("TG " + trackIndex + " " + offset, true);
  },
  ...
  toggleLive() {
    ...
    this.writeCommand(next ? "TF 1" : "TF 0");
  },
